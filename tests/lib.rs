...
fn working_fn_4() {
    ...
    let analysis = read_to_string("tests/function/basic_trait_function.csv");
...
fn working_fn_6() {
    ...
    let analysis = read_to_string("tests/function/extern_function.csv");
...
fn working_inline_2() {
    ...
    let analysis = read_to_string("tests/inline/inline3.csv");
...
fn working_inline_3() {
    ...
    let analysis = read_to_string("tests/inline/inline4.csv");
...
fn working_inline_4() {
    ...
    let analysis = read_to_string("tests/inline/inline5.csv");
...
fn working_reify_6() {
    ...
    let analysis = read_to_string("tests/lifetime/reify_multi_named_self_ret.csv");
...
fn working_reify_7() {
    ...
    let analysis = read_to_string("tests/lifetime/reify_multi_self_ret.csv");
