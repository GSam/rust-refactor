...
fn working_rename() {
	...
	let analysis = "crate,file_name,\"test4.rs\",file_line,1,file_col,0,extent_start,0,extent_start_bytes,0,file_line_end,15,file_col_end,0,extent_end,204,extent_end_bytes,204,name,\"unknown_crate\"
